    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-row gap-4 items-center justify-center mt-4">
          <button
            onClick={() => setCreateBinderOpen(true)}
            className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800 active:outline-none cursor-pointer active:scale-99"
          >
        ...
        <CreateBinderModal
          ...
          onClose={() => setCreateBinderOpen(false)}
        />
      </main>
    </div>
  );
